...
export default function TodoList() {
  return (
    <>
      <div className="flex gap-3 px-[1.5rem] py-4 lg:py-5.5 rounded-t-lg dark:bg-Navy900 bg-Gray50 w-[85%] lg:w-[50%] border-b-[1px] border-Purple700">
        ...
        <p className="text-Gray600 font-semibold">
          text text text text text text tx
        </p>
      </div>
      <div className="flex gap-3 px-[1.5rem] py-4 lg:py-5.5 dark:bg-Navy900 bg-Gray50 w-[85%] lg:w-[50%] border-b-[1px] border-Purple700">
